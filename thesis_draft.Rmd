...
write.csv(tidy_model2, "tidy_model2.csv")
summary(model2)
...
>>>>>>> a56e9ea43589646852bb18da6803dd88b1e801ef
...
```{r}
<<<<<<< HEAD
paste(names(model2$coefficients),": ",round((exp(model2$coefficients)-1)*100,2),"%",sep="")
=======
